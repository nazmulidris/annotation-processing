...
This repo actually contains two IDEA projects. Please do not import this folder into IDEA, instead
import each of the sub folders.

1. `java-javac-project` - Java annotation processing example using `javac` that supports debugging
   in IDEA
